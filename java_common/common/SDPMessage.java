public class SDPMessage{
    public static const int MAX_PACKET_SIZE = 300;
    public static const int MAX_PACKET_SIZE_DATA = 292;
    public static const int REPLY_NOT_EXPECTED = 0x07;
    public static const int REPLY_EXPECTED = 0x87;
    ...
    int length_in_bytes(){
        return this.data_length + this.header.length_in_bytes();
    }
}