...
//!            data
//! \param[in] region_ids the memory addresses of the regions to be recorded to
...
//! \param[in] state_region The memory address in which to store the end of
...
bool recording_initialize(
        ...
        uint32_t *recording_data, address_t state_address,
