...
public class UDPConnection implements AutoCloseable {
    ...
    public UDPConnection(
        String local_host, int remote_port, String remote_host) throws SocketException {
    	this(0, local_host, remote_port, remote_host);
    }
    public UDPConnection(
        int local_port, int remote_port, String remote_host) throws SocketException {
    	this(local_port, null, remote_port, remote_host);
    }

    // The real constructor
    public UDPConnection(
            int local_port, String local_host, int remote_port, String remote_host) throws SocketException {
