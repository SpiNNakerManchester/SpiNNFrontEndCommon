...
class TestSimulatorData(unittest.TestCase):
    ...
    def test_load_run_str(self):
        writer = FecDataWriter.setup()
        run_dir = FecDataView.get_run_dir_path()
        self.assertIn("run_1", run_dir)
        self.assertEqual("", writer.get_load_run_str())
        writer.start_run()
        run_dir = FecDataView.get_run_dir_path()
        self.assertIn("run_1", run_dir)
        self.assertEqual("", writer.get_load_run_str())
        ...
        self.assertIn("run_1", run_dir)
        writer.soft_reset()
        self.assertEqual("3", writer.get_load_run_str())
        run_dir = FecDataView.get_run_dir_path()
        self.assertIn("run_1", run_dir)
        writer.start_run()
        run_dir = FecDataView.get_run_dir_path()
        ...
        writer.soft_reset()
        self.assertIn("run_1", run_dir)
        self.assertEqual("4", writer.get_load_run_str())
        writer.hard_reset()
        self.assertEqual("", writer.get_load_run_str())
        run_dir = FecDataView.get_run_dir_path()
        self.assertIn("run_4", run_dir)
        writer.start_run()
        run_dir = FecDataView.get_run_dir_path()
        self.assertIn("run_4", run_dir)
        self.assertEqual("", writer.get_load_run_str())
        ...
        writer.soft_reset()
        self.assertIn("run_4", run_dir)
        self.assertEqual("5", writer.get_load_run_str())
