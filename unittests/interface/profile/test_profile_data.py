...
class Test(unittest.TestCase):
    ...
    def test_use(self):
        ...
        self.assertEquals(len(profile_data.tags), 2)

        # Should be 0.2ms between "Test" tag start and end, as only one
        self.assertEquals(profile_data.get_mean_ms("Test"), 0.2)

        # Should be 1 call in total of "Test" tag
        self.assertEquals(profile_data.get_n_calls("Test"), 1)
        ...
        self.assertEquals(profile_data.get_n_calls("Test2"), 2)
