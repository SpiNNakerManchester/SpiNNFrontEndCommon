...
def generate_provance_routings(routing_tables, machine, txrx,
    ...
    """
    generates the provenance data for the routing tables of the machine
    :param routing_tables: the routing tabels used in the simulation
    :param machine: the spinnMachien object
    :param txrx: the trasciever object
    :param report_default_directory: where to put this prov data
    :return: none
    """
