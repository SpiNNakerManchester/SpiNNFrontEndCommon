...
class SetRouterEmergencyTimeoutMessage(AbstractSCPRequest):
    ...
    def __init__(self, x, y, p, timeout_mantissa, timeout_exponent):
        ...
        AbstractSCPRequest.__init__(
            ...
            SCPRequestHeader(
                command=ExtraMonitorSupportMachineVertex.
                EXTRA_MONITOR_COMMANDS.SET_ROUTER_EMERGENCY_TIMEOUT.value()),
            argument_1=(timeout_mantissa & 0xF) |
                       ((timeout_exponent & 0xF) << 4))

    def get_scp_response(self):
        return CheckOKResponse(
            "Set router emergency timeout", ExtraMonitorSupportMachineVertex.
            EXTRA_MONITOR_COMMANDS.SET_ROUTER_EMERGENCY_TIMEOUT.value())