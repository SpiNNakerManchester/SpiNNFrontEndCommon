...
class Reload(object):
    ...
    def reload_tags(self, iptags, reverse_iptags):
        """
        reloads the tags required to get the simulation executing
        :param iptags: the iptags from the previous run
        :param reverse_iptags: the reverse iptags from the previous run
        :return:
        """
