...
class ReportState(object):
    ...
    def __init__(self, execute_parittioner_report,
                 ...
                 generate_tag_allocator_report, generate_routing_table_reports):
        ...
        self._generate_routing_table_report = generate_routing_table_reports
    ...
    @property
    def generate_routing_table_report(self):
        """
        returns the flag for generating routing table reports
        :return:
        """
        return self._generate_routing_table_report
