...
from pacman.operations.algorithm_reports.reports import generate_routing_table
...
class RoutingTableFromMachineReport(object):
    ...
    def __call__(self, report_default_directory, routing_tables):
        """
        ...
        tables = routing_tables.routing_tables
