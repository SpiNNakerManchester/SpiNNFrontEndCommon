...
class EnergyReport(object):
    ...
    def __call__(
        ...
        with open(summary_report, "w") as output:
            self._write_summary_report(
                ...
                runtime_total_milliseconds, output,
    ...
    def _write_summary_report(
        ...
        output.write(
            ...
            "     {} kWh\n".format(
                active_chip_cost, runtime, fpga_cost, total_booted_time,
    ...
    def _write_detailed_report(
        ...
        fpga_cost = self._calculate_fpga_cost(
            ...
            total_booted_time, runtime, machine_time_step, time_scale_factor,
            output)
