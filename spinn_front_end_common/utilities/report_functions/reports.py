...
from .utils import csvopen, csvwriter
...
def _write_one_vertex_partition(
        f: TextIO, csv_writer: csvwriter, vertex: ApplicationVertex):
    """
    :param ~io.FileIO f:
...
def _write_one_chip_application_placement(
        f: TextIO, csv_writer: csvwriter, chip: Chip):
    """
    :param ~io.FileIO f:
...
def _write_vertex_virtual_keys(
        f: TextIO, csv_writer: csvwriter, pre_vertex: ApplicationVertex,
