...
class SimpleOnChipRouterCompression(object):
    ...
    def __call__(
        ...
        executable_targets = self._load_executables(
            binary_path, routing_tables, compressor_app_id, transceiver,
            machine)
    ...
    def _load_executables(
            binary_path, routing_tables, compressor_app_id, txrx, machine):
