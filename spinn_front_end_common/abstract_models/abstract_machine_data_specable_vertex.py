...
class AbstractMachineDataSpecableVertex(object):
    """ A vertex that needs data specification to occur
    """
    ...
    def generate_data_spec(
        ...
        :param sub_graph: the machine graph object for this dsg
    ...
    def get_data_spec_file_writers(
        ...
        """
        binary_file_path = \
            AbstractMachineDataSpecableVertex.get_data_spec_file_path(
                processor_chip_x, processor_chip_y, processor_id, hostname,
                application_run_time_report_folder)
