...
class ProfileDataGatherer(object):
    ...
    def __call__(
            ...
            run_time_ms, machine_time_period_map):
        """
        ...
        :param machine_time_period_map: map of vertex to time period
        """
        ...
        for placement in progress.over(placements.placements):
            if isinstance(placement.vertex, AbstractHasProfileData):
                ...
                machine_time_step_ms = (
                    machine_time_period_map[placement.vertex])
                machine_time_step_ms /= MICRO_TO_MILLISECOND_CONVERSION
