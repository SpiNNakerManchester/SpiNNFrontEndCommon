...
class PreAllocateResourcesForChipPowerMonitor(object):
    ...
    def __call__(
            self, machine, n_samples_per_recording, sampling_frequency,
            time_scale_factor, pre_allocated_resources=None):
        """
<<<<<<< HEAD
        ...
        :param int n_samples_per_recording: how many samples between record entries
        :param sint ampling_frequency: the frequency of sampling
