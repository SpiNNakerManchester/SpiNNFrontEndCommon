...
class AbstractSpinnakerBase(ConfigHandler, SimulatorInterface):
    ...
    def add_application_outgoing_partition(
        ...
        """ Adds an outgoing partition to the application graph

        .. note::
            Only needed when the edges in the partition use non-multicast
            traffic.

        :param application_outgoing_partition: the partition
        :type application_outgoing_partition:
    ...
    def application_partition_exists(self, pre_vertex, identifier):
        """ Tests if an application partition exists within the \
            application graph.

        :param ~pacman.model.graphs.application.ApplicationVertex pre_vertex:
            pre-vertex
        :param str identifier: partition identifier
    ...
    def add_machine_outgoing_partition(self, machine_outgoing_partition):
        """ Adds an outgoing partition to the machine graph.
        ...
        :type machine_outgoing_partition:
            ~pacman.model.graphs.AbstractEdgePartition
        """
    ...
    def machine_partition_exists(self, pre_vertex, identifier):
        """ Tests if a machine partition exists within the machine graph.

        :param ~pacman.model.graphs.machine.MachineEdge pre_vertex: pre-vertex
        :param str identifier: partition identifier
        :return: Whether the partition exists.
        :rtype: bool
        """
