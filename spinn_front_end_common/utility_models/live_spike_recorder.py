...
class LiveSpikeRecorder(
        ...
        AbstractIPTagableVertex):
    CORE_APP_IDENTIFIER = constants.SPIKE_RECORDER_CORE_APPLICATION_ID
    SYSTEM_REGION = 0
    ...
    def __init__(self, machine_time_step, tag, port, address):
        ...
        """
        AbstractDataSpecableVertex.__init__(self, label="Monitor",
    ...
    def get_binary_file_name(self, common_binary_folder):
        binary_name = os.path.join(common_binary_folder,
